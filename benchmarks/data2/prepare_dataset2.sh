...
# Clear-up at start
echo "DROP TABLE IF EXISTS dicts.wiki_magic;" | psql -d term_matching_db -U term_matcher -q
echo "DROP TABLE IF EXISTS dicts.wiki_magic_medium;" | psql -d term_matching_db -U term_matcher -q
echo "DROP TABLE IF EXISTS dicts.wiki_magic_small;" | psql -d term_matching_db -U term_matcher -q
