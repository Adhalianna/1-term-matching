...
echo "If the data generated by the current script (which should give approximately 150k entries) is too big, change the depth used by wikipedia crawling algorithm inside the script file."
echo ""
# Clear-up at start
...
#./setup/dictionaries/wikigraph.py Biology 3 wiki_biology en
